...
public interface DiaryRepository extends JpaRepository<Diary, Long> {
   ...
   @Query("SELECT d FROM Diary d WHERE (d.blocks LIKE %:content% OR d.title LIKE %:content%) AND d.userId = :userid")
    Page<Diary> findSearchList(@Param("content") String content, @Param("userid") Long userid, Pageable pageable);
